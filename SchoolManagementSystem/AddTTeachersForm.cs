...
{
    public partial class AddTTeachersForm : UserControl
    {
        ...
        public void teacherDisplayData()
        {
            ...
            teacher_gridData.DataSource = addTD.teachersData();
        }

        private void AddTTeachersForm_Load(object sender, EventArgs e)
        {
        }
                    ...
                    try
                    {
                        ...
                        using (SqlCommand checkTID = new SqlCommand(checkTeacherID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\sudes\source\repos\SchoolManagementSystem\SchoolManagementSystem\Resources\images\", teacher_id.Text.Trim() + ".jpg");
        ...
        public void clearFields()
        {
            ...
            teacher_Image.Image = null; // Corrected here
            imagePath = "";
        }
